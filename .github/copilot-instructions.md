...
- `docs/ftd-knowledge-base.md` - Knowledge base completo da FTD (processos, integrações, ambientes, glossário)
- `docs/discovery/ftd-discovery.md` - Discovery parcial com fit-gap e gaps de investigação
- `docs/especificacao-simulador-notion.md` - Especificação completa do Simulador Comercial (Oscar, 501 linhas)
