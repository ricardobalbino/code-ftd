...
**⚠️ Importante**: Escolha período consistente (month vs quarter vs year). **Recomendado: quarter** para balancear short-term e long-term.
...
**⚠️ Importante**: Ranges são relativos ao seu contexto. Calibre com sua equipe!
