...
- **Knowledge Base**: `.avanade-method/docs/ftd-knowledge-base.md` (LEITURA OBRIGATÓRIA)
- **Discovery**: `.avanade-method/docs/discovery/ftd-discovery.md` (fit-gap, pain points)
- **Especificação Simulador**: `.avanade-method/docs/especificacao-simulador-notion.md` (501 linhas, Oscar)
- **Config D365**: `.avanade-method/configs/d365-config.yaml` (ambientes, integrações, naming)
- **Resumo Completo**: `.avanade-method/docs/ftd-resumo-completo.md`
