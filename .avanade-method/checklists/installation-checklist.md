...
│   │   ├── avanade-supervisor.agent.md     (generated from AVANADE_SUPERVISOR_PROMPT_MD)
│   │   ├── joao-pm.agent.md                (generated from AVANADE_PM_JOAO_PROMPT_MD)
│   │   ├── wilson-architect.agent.md       (generated from AVANADE_ARCHITECT_WILSON_PROMPT_MD)
│   │   ├── maria-analyst.agent.md          (generated from AVANADE_ANALYST_MARIA_PROMPT_MD)
│   │   ├── roberto-sm.agent.md             (generated from AVANADE_SM_PROMPT_MD)
│   │   ├── carla-qa.agent.md               (generated from AVANADE_QA_CARLA_PROMPT_MD)
│   │   ├── tiago-dev.agent.md              (generated from AVANADE_DEVELOPER_TIAGO_PROMPT_MD)
│   │   ├── paula-po.agent.md               (generated from AVANADE_PO_PROMPT_MD)
│   │   ├── sofia-ux.agent.md               (generated from AVANADE_UX_EXPERT_PROMPT_MD)
│   │   └── paige-tech-writer.agent.md      (generated from AVANADE_TECH_WRITER_PAIGE_PROMPT_MD)
│   │
...
|---|---------|--------|------------|
| 1 | `avanade-supervisor.agent.md` | Supervisor - Metacognitive Master | ⬜ |
| 2 | `joao-pm.agent.md` | João - Product Manager | ⬜ |
| 3 | `wilson-architect.agent.md` | Wilson - Architect | ⬜ |
| 4 | `maria-analyst.agent.md` | Maria - Business Analyst | ⬜ |
| 5 | `roberto-sm.agent.md` | Roberto - Scrum Master | ⬜ |
| 6 | `carla-qa.agent.md` | Carla - QA Engineer | ⬜ |
| 7 | `tiago-dev.agent.md` | Tiago - Developer | ⬜ |
| 8 | `paula-po.agent.md` | Paula - Product Owner | ⬜ |
| 9 | `sofia-ux.agent.md` | Sofia - UX Designer | ⬜ |
| 10 | `paige-tech-writer.agent.md` | Paige - Tech Writer | ⬜ |
...
# 1. Agentes Copilot
(Get-ChildItem ".github/agents/*.agent.md" -ErrorAction SilentlyContinue).Count -eq 10
...
**Causa provável**: Arquivo .agent.md incorreto
